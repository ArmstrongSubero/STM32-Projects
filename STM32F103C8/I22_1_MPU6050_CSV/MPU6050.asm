...
STR	R0, [R1, #0]
;MPU6050.c,366 :: 		MadgwickAHRSupdateIMU(gyro_x, gyro_y, gyro_z, acc_x, acc_y, acc_z);
MOV	R5, R0
...
ADD	SP, SP, #8
;MPU6050.c,407 :: 		sprintf(q3_t, "%7.2f,%7.2f,%7.2f,%7.2f\n", q0, q1, q2,q3);
...
LDR	R2, [R0, #0]
MOVW	R1, #lo_addr(?lstr_4_MPU6050+0)
MOVT	R1, #hi_addr(?lstr_4_MPU6050+0)
...
BL	_sprintf+0
ADD	SP, SP, #24
;MPU6050.c,408 :: 		UART1_Write_Text(q3_t);
MOVW	R0, #lo_addr(_q3_t+0)
MOVT	R0, #hi_addr(_q3_t+0)
BL	_UART1_Write_Text+0
;MPU6050.c,411 :: 		Delay_ms(1);
MOVW	R7, #11999
MOVT	R7, #0
NOP
NOP
