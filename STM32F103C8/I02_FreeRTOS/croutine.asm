croutine_ucPortCountLeadingZeros:
...
BX	LR
; end of croutine_ucPortCountLeadingZeros
croutine_xPortIsInsideInterrupt:
...
CMP	R0, #0
IT	NE
BNE	L_croutine_xPortIsInsideInterrupt0
;portmacro.h,228 :: 		xReturn = pdFALSE;
MOV	R0, #0
STR	R0, [SP, #4]
;portmacro.h,229 :: 		}
IT	AL
BAL	L_croutine_xPortIsInsideInterrupt1
L_croutine_xPortIsInsideInterrupt0:
;portmacro.h,232 :: 		xReturn = pdTRUE;
MOV	R0, #1
STR	R0, [SP, #4]
;portmacro.h,233 :: 		}
L_croutine_xPortIsInsideInterrupt1:
...
ADD	SP, SP, #8
BX	LR
; end of croutine_xPortIsInsideInterrupt
croutine_vPortRaiseBASEPRI:
...
ADD	SP, SP, #4
BX	LR
; end of croutine_vPortRaiseBASEPRI
croutine_ulPortRaiseBASEPRI:
...
ADD	SP, SP, #8
BX	LR
; end of croutine_ulPortRaiseBASEPRI
croutine_vPortSetBASEPRI:
...
BX	LR
; end of croutine_vPortSetBASEPRI
