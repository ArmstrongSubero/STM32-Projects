...
// These format the raw data provided by the uxTaskGetSystemState() function
// in to human readable ASCII form.  See the notes in the implementation
// of vTaskList() within FreeRTOS/Source/tasks.c for limitations.
